...
\begin{itemize}
    ...
    \item \textbf{Error} (flashError()): no hay señal luminosa. La función existe como punto de extensión para una eventual señal de error, pero por ahora no enciende ni apaga nada.
\end{itemize}
